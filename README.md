...
│       ├── yandex_metrika_phrases_YYYY-MM-DD_HH-MM-SS.csv/.md     # Поисковые фразы
│       ├── yandex_metrika_pages_YYYY-MM-DD_HH-MM-SS.csv/.md       # Страницы
│       ├── yandex_metrika_visitors_YYYY-MM-DD_HH-MM-SS.csv/.md    # Посетители
│       └── yandex_metrika_traffic_YYYY-MM-DD_HH-MM-SS.csv/.md     # Источники трафика
└── .opencode/skills/
...
**Пользователь:**
> Проанализируй источники трафика на сайт за последние две недели. Перечисли источники которые дают больше всего качественного трафика. Дай сводку и выводы.

**Агент (рассуждения):**
> Загружаю skill для анализа трафика. Запускаю несколько запросов параллельно: источники трафика, поисковые системы, социальные сети, реферальные домены. Период: последние 14 дней. Анализирую метрики качества: процент отказов, глубина просмотра, время на сайте...

**Агент (ответ):**

---

**Сводка по источникам трафика (17.02 - 03.03.2026)**

**Топ источников по качеству трафика**

| Источник | Визиты | Отказы % | Глубина | Время (сек) | Качество |
|----------|--------|----------|---------|-------------|----------|
| **Messenger traffic** | 2 | 0% | 6.0 | 298.5 | ⭐⭐⭐⭐⭐ |
| **Yandex Mobile** | 75 | 4% | 1.16 | 112.1 | ⭐⭐⭐⭐⭐ |
| **Link traffic** | 29 | 6.9% | 1.31 | 75.8 | ⭐⭐⭐⭐ |
| **Google (search)** | 14 | 7.14% | 1.07 | 28.6 | ⭐⭐⭐⭐ |
| **Yandex (search)** | 275 | 8.73% | 1.27 | 128.8 | ⭐⭐⭐⭐ |
| **Direct traffic** | 90 | 28.89% | 1.69 | 136.5 | ⭐⭐⭐ |

**Выводы**

*Лучшие по качеству:*
- **Yandex Mobile** — самый качественный массовый источник (4% отказов)
- **Yandex (search)** — основной источник (275 визитов, 8.73% отказов, хорошее время)
- **Direct traffic** — лояльная аудитория (максимальное время 136 сек, высокая глубина 1.69)

*Основной трафик:*
- Яндекс даёт 96% поискового трафика (350/366 визитов)
- Google почти не представлен (всего 15 визитов)
- prikotov.pro — крупный реферальный источник (531 визит)

*Проблемы:*
- Нет трафика из соцсетей
- Низкая доля Google
- Мессенджеры почти не используются (2 визита), но потенциально эффективны
